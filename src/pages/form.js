                ...
                <form action="/register" method="POST">
                    ...
                    <div>
                        ...
                        <fieldset name="daytime">
                            <input type="checkbox" id="morning" name="daytime" value="morning" />
                            <label for="morning">Morning</label>
                            <input type="checkbox" id="afternoon" name="weekday" value="afternoon" />
                            <label for="afternoon">Afternoon</label>
                            <input type="checkbox" id="evening" name="weekday" value="evening" />
                            <label for="evemomg">Evening</label>
                            <input type="checkbox" id="night" name="weekday" value="night" />
                    ...
                    <div>
                        ...
                        <fieldset name="difficulty">
                            <input type="radio" id="dificult" name="difficulty" value="dificult" />
                    ...
                    <div>
                        ...
                        <fieldset name="durration">
                            <input type="radio" id="upkeep" name="durration" value="regular-upkeep" />
                            <label for="upkeep">Regular-Upkeep (1 hour or less)</label>
                            <input type="radio" id="task" name="durration" value="fast-task" />
                            <label for="task">Fast-Task (30 min or less)</label>
                            <input type="radio" id="quick" name="durration" value="quick-bit" />
